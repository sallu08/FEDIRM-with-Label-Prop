...
def args_parser():
     ...
     parser.add_argument('--root_path', type=str, default='data/brain/research/dept8/qdou/data/RSNA-ICH/organized/stage_2_train', help='dataset root dir')
     parser.add_argument('--csv_file_train', type=str, default='data/brain/research/dept8/qdou/data/RSNA-ICH/training.csv', help='training set csv file')
     parser.add_argument('--csv_file_val', type=str, default='data/brain/research/dept8/qdou/data/RSNA-ICH/validation.csv', help='validation set csv file')
     parser.add_argument('--csv_file_test', type=str, default='data/brain/research/dept8/qdou/data/RSNA-ICH/testing.csv', help='testing set csv file')
     ...
     parser.add_argument('--num_users', type=int,  default=10, help='number of clients participating')
     parser.add_argument('--rounds', type=int,  default=100, help='Total no of federated epoch')
